...
export const coachQuestions = [
  ...
  { key: "goal", label: "Goal", type: "select", options: ["fat_loss", "muscle_gain", "maintenance", "endurance", "general_fitness", "strength"] },
  { key: "experience", label: "Training experience", type: "select", options: ["beginner", "intermediate", "advanced"] },
  { key: "activityLevel", label: "Activity level", type: "select", options: ["sedentary", "light", "moderate", "active", "very_active"] },
  ...
  { key: "dietPreference", label: "Diet preference", type: "select", options: ["normal", "vegetarian", "vegan", "halal", "pescatarian", "high_protein"] },
  ...
  { key: "targetWeightKg", label: "Target body weight (kg)", type: "number" },
